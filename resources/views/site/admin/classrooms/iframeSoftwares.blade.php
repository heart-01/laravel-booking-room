    ...
    <div class="container-fluid">  
      ...
      <div class="d-flex justify-content-center mt-3">
        ...
        <fieldset id="left" class="text-center mt-5">
            <ul id="list" class="sortable">
              @foreach($data1 as $row)
                <li>
                  <p>{{ $row->softwares }}</p>
                  <?= Form::hidden('softwares_id[]', $row->softwares_id); ?>
        ...
        <fieldset id="right" class="text-center mt-5">
            <?= Form::open(array('route' => 'addSoftwares.store','files' =>true)) ?>
    ...
    $(document).ready(function(){       
        ...
        $('#btnSave').click(function(){
            if($('#selc li').length > 0){
                ...
                Swal.fire("<span class='kanin'>กรุณาเลือกรายการซอฟแวร์</span>", "", "warning");
            }                
        });
    });    
  </script>
