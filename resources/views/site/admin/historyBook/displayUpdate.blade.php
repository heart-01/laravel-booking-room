...
<div id="page_BookingUpdate" class="card kanin">
  <div class="card-header">
      <div class="row text-center">
        <a id="back-history" class="btn btn-secondary text-white col-md-2 col-lg-2 col-xl-1 d-none d-sm-none d-md-block d-lg-block" href="{{ route('dashboard') }}">
          <i class="fas fa-chevron-left mr-1"></i> กลับไป
        </a>
        <a class="btn btn-secondary text-white d-block d-sm-block d-md-none d-lg-none col-sm-12 mb-3" href="{{ route('dashboard') }}">
          <i class="fas fa-chevron-left mr-1"></i> กลับไป
        </a>

        <h4 class="col-sm-12 col-md-10 col-lg-10 col-xl-11">แก้ไขข้อมูลการจองห้องเรียน</h4>
      </div>
  </div>
  <!-- /.card-header -->
  <div class="card-body">
    ...
    <div class="container mt-5">
        ...
        <button type="submit" id="btnfrmBookingUpdate" class="btn btn-success btn-block mt-5 mb-3"><i class="fas fa-calendar-check mr-1"></i> ยืนยัน</button>
        <?= Form::close() ?>
    </div>
  ...
  <!-- /.card-body -->
    ...
    <script src="{{ asset('js/admin/historyBook/displayUpdate.js') }}"></script>
@endsection